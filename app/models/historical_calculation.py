...
class HistoricalCalculation(Base):
    ...
    unit = Column(String, nullable=True)  # Unit: "ones", "thousands", "millions", "billions", or "ten_thousands"
    ...
    effective_tax_rate = Column(Numeric(10, 4), nullable=True)  # Stored as decimal (e.g., 0.25 for 25%)
