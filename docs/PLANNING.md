...
_See `docs/COMPLETED_TASKS.md` for detailed history._
...
- [x] CPB case - for the 10-Q, tiger-transformer does not recognize EBIT
- [x] WIX case - total revenue line is not labeled
...
- **Two-Stage Validation**:
  1. **Completeness Check**: LLM verifies chunk has full table _before_ extraction.
