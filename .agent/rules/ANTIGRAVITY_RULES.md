...
3. **Cycle**: Create Tests -> Implement Code -> Pass Tests -> Update Docs (`PLANNING.md`, `UI_UX_DESIGN.md`, `ARCHITECTURE.md`, `PRODUCT_SPECS.md`).
4. **Design Compliance**: All UI changes MUST follow `UI_UX_DESIGN.md`.