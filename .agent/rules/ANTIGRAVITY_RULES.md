...
4. Refactor: ALWAYS shrink the code base if possible.
5. Cycle: Create Tests -> Implement Code -> Pass Tests -> Update Docs (`PLANNING.md`, `UI_UX_DESIGN.md`, `ARCHITECTURE.md`, `PRODUCT_SPECS.md`).